// client/src/pages/bidder/BidderApplyPage.jsx
...
export default function BidderApplyPage() {
  ...
  async function load(targetPage = page) {
    setIsLoading(true);
    const res = await api(
      `/bidder/profiles/${profileId}/apply-data?q=${encodeURIComponent(
        query
  ...
  return (
    <div className="page-grid">
      <PageHeader
        ...
        subtitle="Add applies, filter by date, and browse 100 rows per page."
        action={
          <button
            onClick={() => {
              setEditing(null);
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          <div className="stat-title">Interviews This Week</div>
          <div className="stat-value">{data.interviews?.length || 0}</div>
        </div>
      </div>
      ...
      <div className="panel">
        <h3>Scheduled Interviews This Week</h3>

        {!data.interviews || data.interviews.length === 0 ? (
          <p>No interviews this week.</p>
        ) : (
